...
export class Users1714123101025 implements MigrationInterface {
    name = 'Users1714123101025'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_authmethod_enum" AS ENUM('local', 'google')`);
